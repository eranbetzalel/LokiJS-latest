...
(function (root, factory) {
  ...
  return (function () {
    ...
    function Cache(name, options) {
      ...
      this.cacheDataRefreshTime = options.refresh;
      ...
      if (loadFunc) {
        ...
        boundLoadFunc();
        setInterval(boundLoadFunc, this.cacheDataRefreshTime);
      }
    ...
    Cache.prototype.setLoadFunc = function (loadFunc) {
      var boundLoadFunc = loadFunc(this);
      boundLoadFunc();
      return setInterval(boundLoadFunc, this.cacheDataRefreshTime);
    };
